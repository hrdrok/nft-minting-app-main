...
const ADDRESS = "0x5230b083AaAe9e43dEB9bA5ebCAFaa31A643c1EF";
...
<form class="gradient col-lg-5 mt-5" style={{borderRadius:"25px",boxShadow:"1px 1px 15px #000000"}}>
  <h4 style={{color:"#FFFFFF"}}>Gallery</h4>
  ...
  <h5 style={{color:"white", textShadow:"1px 1px 3px #000000"}}> NFTs Minted so far= {balance.result}/10000</h5>
</form>
<div className="row items mt-3">
<div className="ml-3 mr-3" style={{display: "inline-grid",gridTemplateColumns: "repeat(4, 5fr)",columnGap: "10px", rowGap: "10px"}}>
{nftdata.map(result => {
	return (
		  <div className="card">
				  ...
				  <div className="card-caption col-12 p-0">
					  <div className="card-body">
						  <h5 className="mb-0">The Crackin Krakens #{result.tokenID}</h5>
